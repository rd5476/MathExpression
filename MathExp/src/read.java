...
class read extends PDFTextStripper{
     ...
     */
    public read(PDDocument doc, HashMap<Character,String> unicodeDictionary) throws IOException {
        super();
        document =doc;
    ...
    public PageStructure readText(int pagenum) throws IOException {
        PageStructure page = new PageStructure(pagenum,new ArrayList<Line>(),null,
                ...
                new HashMap<Integer, compundCharacter>());
        BoundingBox BBox = new BoundingBox(document,pagenum,page,unicodeDictionary);
